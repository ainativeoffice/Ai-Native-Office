...
import { content, type ListItem, type Principle, type Table, type ContactBlock, type Section } from "@/lib/content/content";
import { Citation, CitationBrackets } from "./Citation";
import { SideNote, type MarginNote } from "./SideNote";
import { getSource, tokenizeCitationGroups } from "@/lib/content/citations";
import { splitEmphasis } from "@/lib/content/emphasis";
import { EgressCalculator } from "./EgressCalculator";
 ...
 * tokenization) so markers can never span a citation boundary.
 */
...
/** KaTeX renders identically on server and client (pure string → HTML). */
...
/** Tufte-style marginalia — empty array since no notes are in the content yet. */
...
/**
 * Data-driven cross-links from a main section to its supporting appendices.
 */
